...
pub async fn get_video(video_id:String, params: String) ->Result<VideoQuery,  Error>{
    ...
    */
    ...
    let video_player = extract_video_player_formats(&player_json);
    let video: Video = video_from_next_and_player(&player_json["videoDetails"], &next_video_data, video_player);
